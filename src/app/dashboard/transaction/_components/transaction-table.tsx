...
export default function TransactionTable({
   transactions, isLoading, refetch, page, limit,
   search, setPage, setLimit, setSearch,
}: {
   ...
   }, [localSearch, search, setPage, setSearch]); // Menambahkan dependency array agar tidak terjadi infinity loop

   // State ini yang menjadi acuan tipe datanya
